...
Dragon Tiger（龙虎斗）是一款经典的亚洲卡牌游戏，玩家预测龙或虎谁的牌点数更大，或者预测平局。游戏简单快速，支持三种投注类型，RTP 为 97.0%。
...
- **三种投注**：龙投注、虎投注、和投注
- **试玩模式**：支持免费试玩体验
- **RTP 机制**：龙/虎投注派彩应用 97% RTP
- **平局退款**：平局时龙/虎投注退回 50%（应用 RTP）
...
#### 龙投注 / 虎投注
- **基础赔率**：1:1
- **实际赔率**：应用 97% RTP 后为 0.97:1
- **示例**：投注 10.00，赢得 9.70（10 × 0.97）
...
- 当结果为平局（tie）时：
  - 和投注按 1:8 派彩
  - 龙投注退回 50%（应用 RTP，10.00 投注退回 4.85）
  - 虎投注退回 50%（应用 RTP，10.00 投注退回 4.85）
...
- 龙赢：赢得 9.70（龙派彩）
- 虎赢：损失 15.00
- 平局：赢得 44.85（和派彩 40.00 + 龙退款 4.85）
